...
class NepaliCalendar
{
    ...
    public static function getNepaliDate($post)
    {
        $npcal = new NepaliCalendar();

        $np_date = $npcal->eng_to_nep($post->created_at->year, $post->created_at->month, $post->created_at->day);
    ...
    public static function today()
    {
        ...
        $np_date = $npcal->eng_to_nep($today->year, $today->month, $today->day);
